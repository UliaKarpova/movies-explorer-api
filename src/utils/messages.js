module.exports.uncorrectedDataErrorMessage = 'Переданы некорректные данные';
...
module.exports.errorMessage = 'Произошла ошибка';
module.exports.needAuthorizationErrorMessage = 'Необходима авторизация';

module.exports.forbiddenDeleteCardErrorMessage = 'Можно удалять только своё видео';
module.exports.movieRemoved = 'Фильм удалён';

module.exports.uncorrectedEmailOrPasswordMessage = 'Неправильные почта или пароль';
...
module.exports.imageUncorrectedError = 'Поле image должно содержать ссылку';
module.exports.trailerRequiredError = 'Поле trailer обязательно для заполнения';
module.exports.trailerUncorrectedError = 'Поле trailer должно содержать ссылку';
